...
/**
 * A test that runs a collection of Simplex scripts, and verifies that they behave correctly.
 *
 * Each directory under src/tests/resources/scripts is a test. Within each directory 'foo':
