        ...
        listOf(
            object :
                PrimitiveFunctionValue(
                    ...
                    FunctionSignature.simple(
                        ParameterSignature(listOf(Parameter("points", Type.vector(Vec2ValueType.asType)))), asType),
                ) {
            ...
            object :
                PrimitiveFunctionValue(
                    "polygons_hull",
                    FunctionSignature.simple(
                        ParameterSignature(listOf(Parameter("polygons", Type.vector(asType)))),
    ...
    override val providesPrimitiveMethods: List<PrimitiveMethod> by lazy {
        listOf(
            object :
                PrimitiveMethod(
                    "points",
                    MethodSignature.simple(asType, ParameterSignature.empty, Type.vector(Vec2ValueType.asType)),
                ) {
