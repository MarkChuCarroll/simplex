...
object Extrude {
    ...
    fun points(dir: Vector3d, points: List<Vector3d>): CSG {
        val newList = ArrayList<Vector3d>(points);
     ...
     */
    fun  points(dir: Vector3d, top: Boolean, bottom: Boolean, points1: List<Vector3d>): List<Polygon> {
        val newList1 = ArrayList<Vector3d>(points1)
     ...
     * @return List of polygons
     */
    fun combine(p1: Polygon, p2: Polygon, bottom: Boolean, top: Boolean): List<Polygon> {
    ...
    fun extrude(dir: Vector3d, polygon1: Polygon): CSG {
        val newPolygons = ArrayList<Polygon>()
    ...
    fun extrude(dir: Vector3d, polygon1: Polygon, top: Boolean, bottom: Boolean): List<Polygon> {
        val newPolygons = ArrayList<Polygon>()
        if (bottom) {
            newPolygons.addAll(PolygonUtil.concaveToConvex(polygon1));
        }
    ...
    fun normalizedX(v1: Vector3d, v2: Vector3d): Double {
