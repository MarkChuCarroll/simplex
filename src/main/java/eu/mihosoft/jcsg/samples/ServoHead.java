...
public class ServoHead {
    ...
    public CSG servoTooth() {
        ...
        //     |    tl    |
        //
        return Extrude.points(Vector3d.xyz(0, 0, headHeight),
                Vector3d.xy(-toothLength / 2, 0),
    ...
    public CSG servoHeadMale() {
        ...
        CSG cylinder = new Cylinder(
                Vector3d.xyz(0, 0, 0), Vector3d.xyz(0, 0, headHeight),
...
//        cyl1 = cyl1.transformed(Transform.unity().translateZ(0.1));
        ...
        return headFinal.transformed(Transform.unity().rotX(180).translateZ(-headHeight-headThickness));
    }
